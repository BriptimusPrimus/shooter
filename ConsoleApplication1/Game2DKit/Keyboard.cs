...
namespace Game2DKit.Input
{
    ...
    {
        public static OpenTK.Input.KeyboardDevice GameKeyboard;
        ...
        public static KeyboardState GetState()
        {
            ...
            return new KeyboardState(GameKeyboard);    
        }
    }
    
    public class KeyboardState
    {
        private bool[] KeysPressed = new bool[Enum.GetValues(typeof(OpenTK.Input.Key)).Length];
        ...
        public KeyboardState(OpenTK.Input.KeyboardDevice keyboard)
        {
            for (int i = 0; i < KeysPressed.Length; i++)
            {
                KeysPressed[i] = keyboard[(OpenTK.Input.Key)i];
            }
        }
        ...
        public bool Equals(KeyboardState other)
        {
            for (int i = 0; i < KeysPressed.Length; i++)
            {
                if (KeysPressed[i] != other.KeysPressed[i])
                {
                    return false;
                }
            }
